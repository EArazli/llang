...
import Strat.Pipeline (Pipeline, Run, DerivedDoctrine, FragmentDecl, TransformerDecl)
...
data ModuleEnv = ModuleEnv
  ...
  , meTransformers :: M.Map Text TransformerDecl
...
mergeEnv a b = do
  ...
  transformers <- mergeMap "transformer" meTransformers
